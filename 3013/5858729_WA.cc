...
const unsigned long long N = 100010;
unsigned long long head[N],next[N*2],v[N*2];
...
int main()
{
	unsigned long long E,V,C;
	unsigned long long pn,hn;
	unsigned long long x,y,now,vv,cnt;
